...
export const COLUMN_GLOSSARY: Record<string, Record<string, string>> = {
  ...
  hr_attrition: {
    ...
    WorkLifeBalance: "워라밸 만족도 (1~4)",
    JobSatisfaction: "직무 만족도 (1~4)",
    EducationField: "전공 분야",
    YearsInCurrentRole: "현재 직무를 맡은 연수",
    Department: "소속 부서",
    PercentSalaryHike: "지난해 연봉 인상률 (%)",
    HourlyRate: "시급",
    MonthlyRate: "월 급여율 (회사 내부 지표)",
    YearsSinceLastPromotion: "마지막 승진 이후 연수",
    TrainingTimesLastYear: "지난해 교육 참여 횟수",
